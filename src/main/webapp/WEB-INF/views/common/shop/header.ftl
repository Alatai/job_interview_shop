...
<head>
    ...
    <!-- bootstrap css -->
    <link rel="stylesheet" href="http://localhost:8080/jishop/css/bootstrap.min.css" type="text/css">
    <!-- font awesome -->
    <link rel="stylesheet" href="http://localhost:8080/jishop/css/all.min.css" type="text/css">
    <!-- custom css -->
